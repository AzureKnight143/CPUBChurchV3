    ...
    <main class="site-main" id="main">
        <div class="<?php echo esc_attr($container); ?>">
            <div class="highlights">
                <?php if (get_theme_mod('highlight_main_text_1') && get_theme_mod('highlight_link_1')) { ?>
                ...
                <?php } ?>
                <?php if (get_theme_mod('highlight_main_text_2') && get_theme_mod('highlight_link_2')) { ?>
                ...
                <?php } ?>
                <?php if (get_theme_mod('highlight_main_text_3') && get_theme_mod('highlight_link_3')) { ?>
